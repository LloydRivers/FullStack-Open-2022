...
+---------------------+-----------------------+----------------+-------------------------------+
| Asymptotic Notation | What it Represents    | What it Checks | Child-Friendly Explanation    |
+---------------------+-----------------------+----------------+-------------------------------+
| Big O               | Worst Case            | Upper Bound    | It tells us the maximum amount of time an an algorithm may take to run. It's like setting an alarm clock for the latest possible time you need to wake up. 
+---------------------+-----------------------+----------------+-------------------------------+

| Big Theta           | Average Case          | Tight Bound    | It represents the typical or average amount of time an algorithm takes to run. It's like the expected time it usually takes you to finish your homework. 

+---------------------+-----------------------+----------------+-------------------------------+

| Big Omega           | Best Case             | Lower Bound    | It tells us the minimum amount of time an algorithm may take to run. It's like a guarantee that something won't take longer than a specific time. 
+---------------------+-----------------------+----------------+-------------------------------+
*/
